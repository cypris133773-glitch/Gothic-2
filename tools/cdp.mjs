...
const KEYS = {
  ...
  KeyT: [84, 't'], KeyI: [73, 'i'], KeyJ: [74, 'j'], KeyK: [75, 'k'], KeyR: [82, 'r'], KeyL: [76, 'l'], KeyP: [80, 'p'], KeyM: [77, 'm'], KeyN: [78, 'n'], Enter: [13, 'Enter'], F9: [120, 'F9'],
  Digit1: [49, '1'], Digit2: [50, '2'], Digit3: [51, '3'],
  Digit4: [52, '4'], Digit5: [53, '5'], Digit6: [54, '6'], Digit7: [55, '7'],
  Digit8: [56, '8'], Digit9: [57, '9'], Escape: [27, 'Escape'],
